...
### Fixed
- Added defensive check in scheduler config reload to handle edge case where cron.Next() returns zero time

## [3.1.1] - 2026-02-01

### Fixed
- Fixed scheduler race condition where config reload could invalidate job pointer during manual trigger
...
### Fixed
- Fixed default agent modes to use heavy tier
- Fixed agent test suite race conditions and test response field mismatches

### Changed
- Refactored HTTP client TLS handling into tlsutil package for better code organization
- Improved smoke test reliability and coverage

## [3.0.2] - 2026-01-21

### Fixed
- Fixed deployment script port configuration
